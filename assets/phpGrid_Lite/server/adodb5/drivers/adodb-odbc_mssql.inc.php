...
class  ADODB_odbc_mssql extends ADODB_odbc {	
	...
	var $metaColumnsSQL = "select c.name, t.name, c.length, c.isnullable, c.status from syscolumns c join systypes t on t.xusertype=c.xusertype join sysobjects o on o.id=c.id where o.name='%s'";
