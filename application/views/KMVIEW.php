...
<title>AVERAGE KILOMETER VIEW</title>
...
<div class="row">
	...
	<form class="well form-inline" name="input" action="/balaraam_mine/kmlogcon/kmmonth" method="post"> 
...
<div class="well" style="margin-top: 95px;"> <?php ECHO $tablevolvo  ?>
</div>
</body>
</html>
